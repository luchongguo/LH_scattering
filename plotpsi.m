function [gvar,a,k,rhopsi]=plotpsi()
%testDir='E:\density_fluction - 副本\Gfile';
testDir='F:\cbwu\办公\density_fluction_0408\genraydata';
...
%%
figure(1);
 [c,h]=contourf(rgrid,zgrid,-gvar.psirz',50);
% %  figure();
